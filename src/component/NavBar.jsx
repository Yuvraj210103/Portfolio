    ...
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-200 z-20">
      ...
      <div className="hidden md:flex">
        <ul className="flex">
          ...
          <li>  <Link  to="ContactForm"  smooth={true}  duration={500} >Contact</Link></li>
        </ul>
      </div>
      ...
      >
        ...
        <li  className="py-6 text-4xl"><Link onClick={handleClick} to="ContactForm"  smooth={true}  duration={500} >Contact</Link></li>
      </ul>
     ...
     <div className="md:flex flex-row md:fixed md:flex-col md:top-[35%] md:left-0 hidden top-[80%] ">
      <ul>
        ...
        <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[100px] duration-300 bg-blue-500">
          <a href="https://github.com/Yuvraj210103" className="flex justify-between items-center w-full text-gray-300">
            Github <FaGithub size={25}/>
          </a>
        </li>
        <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[100px] duration-300 bg-[#6fc2b0]">
          <a href="/" className="flex justify-between items-center w-full text-gray-300">
